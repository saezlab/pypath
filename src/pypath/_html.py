...
_rwth_aachen_logo = u'''data:image/png;base64,
    '''.replace('\n', '').replace(' ', '')

_tgac_logo = u'''data:image/png;base64,
    
    0JEnHIwVGWOMS5WqMZsGZ92Msc34P8bQP064TG38AAAAAElFTkSuQmCC'''\
    .replace('\n', '').replace(' ', '')
...
def default_template(content, page_title, title = ''):
    page = u'%s\n\t<img src="%s" alt="EMBL-EBI"/>\n\t'\
            '<img src="%s" alt="JRC-COMBINE, RWTH Aachen"/>\n\t'\
            '<img src="%s" alt="TGAC"/>\n\t'\
            '<h1>%s</h1>\n\t%s\n%s' % \
