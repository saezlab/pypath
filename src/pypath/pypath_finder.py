...
# <-----
    ...
    def build_query(self, nodes, verbose=False):
        ...
        * Arguments:
        ...
        for name, n in self.query.iteritems():
            ...
            if direct:
                ...
                for mname, m in self.query.iteritems():
                    if m == n:
                        pass
...
class Main2: # TODO: Add/re-implement network reduction?
    '''
