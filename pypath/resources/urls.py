...
urls = {
    ...
    'mirbase' : {
        ...
        'root': 'https://mirbase.org/download/CURRENT/database_files/%s.txt',
    },
    'mir2dis': {
    ...
    'bindingdb': {
        ...
        'url':
        'https://bindingdb.org/rwd/bind/chemsearch/marvin/SDFdownload.jsp?download_file=/rwd/bind/downloads/BindingDB_%s_202605_tsv.zip',
